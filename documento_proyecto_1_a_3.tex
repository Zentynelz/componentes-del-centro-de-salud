...
id\_enfermedad & INT & FK $\rightarrow$ ENFERMEDAD, NULL, DEFAULT NULL & Enfermedad diagnosticada (del cat\'alogo) \\ \hline
...
BEGIN
    IF p_enfermedad IS NULL OR TRIM(p_enfermedad) = '' THEN
        ...
        SET MESSAGE_TEXT = 'Debe ingresar una enfermedad para la búsqueda.';
    END IF;
...
CREATE TABLE diagnostico (
    ...
    CONSTRAINT fk_diagnostico_paciente
        FOREIGN KEY (id_paciente) REFERENCES paciente(id_paciente)
        ON DELETE CASCADE,
    CONSTRAINT fk_diagnostico_enfermedad
...
-- Se agrega la FK a enfermedad para los diagn\'osticos
...
LEFT JOIN medico med ON p.id_empleado_medico = med.id_empleado
LEFT JOIN empleado em ON med.id_empleado = em.id_empleado
